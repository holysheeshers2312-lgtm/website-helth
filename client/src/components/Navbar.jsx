...
import { ShoppingBag, Menu, X, MapPin, LogIn, LogOut, User } from 'lucide-react';
    ...
    return (
        <nav
            className={cn(
                ...
                scrolled
                    ? 'bg-black/60 backdrop-blur-xl border-white/10 py-3 shadow-[0_4px_30px_rgba(0,0,0,0.5)]'
                ...
                <div className="hidden md:flex items-center gap-8">
                    {navLinks.map((link) => (
                        <Link
                            ...
                            to={link.path}
                            className={cn(
                                "detail-text font-medium transition-colors hover:text-primary",
                ...
                {isOpen && (
                    ...
                    >
                        <div className="flex flex-col p-4 gap-4">
                            ...
                            <Link to="/checkout" className="flex items-center gap-2 text-gray-300">
                            ...
                            {isAuthenticated ? (
                                <div className="space-y-2">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 text-gray-300 hover:text-primary transition-colors w-full"
                                    >
                                        <LogOut size={18} />
                                        Logout
                                    </button>
