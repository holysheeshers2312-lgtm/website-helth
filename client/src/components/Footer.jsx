...
const legalContent = {
    privacy: (
        <>
            ...
            <p>At Spice Route, we respect your privacy and are committed to protecting your personal data. This Privacy Policy describes how we look after your personal data when you visit our website.</p>
    ...
    terms: (
        <>
            <p><strong>Welcome to Spice Route.</strong></p>
            <p>These terms and conditions outline the rules and regulations for the use of Spice Route's Website.</p>
            <h3 className="text-white font-bold text-lg mt-4">1. License</h3>
            <p>Unless otherwise stated, Spice Route and/or its licensors own the intellectual property rights for all material on Spice Route. All intellectual property rights are reserved.</p>
            <h3 className="text-white font-bold text-lg mt-4">2. Restrictions</h3>
    ...
    refund: (
        <>
            ...
            <h3 className="text-white font-bold text-lg mt-4">1. Order Errors</h3>
            ...
            <h3 className="text-white font-bold text-lg mt-4">2. Order Incomplete</h3>
            <p>On specific occasions, we may miss an item. We will refund you specifically for the missed item.</p>
            <h3 className="text-white font-bold text-lg mt-4">3. Food Dissatisfaction</h3>
    ...
    return (
        <footer className="bg-secondary/50 border-t border-white/5 py-12 mt-20">
            ...
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 className="text-2xl font-serif text-primary font-bold mb-4">Spice Route</h3>
                    <p className="text-gray-400">
                        Authentic Indian flavors delivered to your doorstep. Experience the essence of tradition in every bite.
                    </p>
                </div>
            ...
            <div className="container mx-auto px-4 mt-8 pt-8 border-t border-white/5 text-center text-gray-500 text-sm">
                © {new Date().getFullYear()} Spice Route. All rights reserved.
            </div>
        </footer>
    );
}
